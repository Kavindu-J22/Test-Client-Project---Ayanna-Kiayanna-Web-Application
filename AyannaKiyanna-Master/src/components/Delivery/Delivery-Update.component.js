        ...
        axios.get('http://localhost:5000/Delivery/' + this.props.match.params.id)
            .then(response => {
                this.setState({
                    ...
                    DPPlace: response.data.DPPlace,
                    DPItem: response.data.DPItem,
...
onChangeContactno(e) {
    ...
    render() {
        return (<div  >
            ...
            <div class = "col-6" >
            <br/>
            <img src="https://img.freepik.com/free-vector/project-delivery-illustration_335657-4688.jpg?w=2000" width="100%" height="100%" />
            </div> <div class = "col-6" >
