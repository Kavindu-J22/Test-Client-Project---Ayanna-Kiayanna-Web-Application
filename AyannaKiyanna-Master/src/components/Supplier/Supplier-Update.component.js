 ...
 onChangeEmail(e) {
    ...
    render() {
        return (<div  >
            ...
            <div class = "col-6" >
            <br/>
            <img src="https://thumbs.dreamstime.com/b/market-research-studies-abstract-concept-vector-illustration-explore-new-segment-product-testing-customers-needs-brand-management-183359543.jpg" width="100%" height="90%" />
            </div> <div class = "col-6" >
            <div div class = "myformstyle" >
            <div className = "card-body" >
            <div className = "col-md-8 mt-4 mx-auto" > </div> 
            <h3 className = "text-center" > 
            <font face = "Comic sans MS" size = "6" > Update Seller Details </font>
            </h3 > <br></br>
